# Generated by Django 3.1.1 on 2020-10-19 12:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text="Enter the book's natural language (e.g. Japanese, English etc.)", max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
